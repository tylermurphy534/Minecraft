...
public class MousePicker {
	...
	public static void update() {
		viewMatrix = Maths.createViewMatrix(Scene.camera);
		currentRay = calculateMouseRay();
		breakPos = search(Scene.chunks,currentRay,Scene.player.getPosition(), 0);
	...
	private static Vector3f search(List<Chunk> chunks, Vector3f ray, Vector3f position, int recursionCount) {
		Vector3f ppos = Scene.player.getPosition();
